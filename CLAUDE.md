...
Estructura vigente (`v3.3.75`). URLs canónicas de entregables: `/publicados/[cliente]/...` (legacy `/portal/analisis/...` resuelve por 301). El simulador no tiene URL pública: se sirve bajo `/core/simulador-ux/...`.
...
Versionado Semántico (`MAJOR.MINOR.PATCH`). **Versión actual:** `v3.3.75`.
