...
| CT-7 | Las 3 constantes hardcodeadas en `portal/index.html` (`ANALISIS_BASE_PATH`, `ANALISIS_DIAGNOSTICO_PATH`, `ANALISIS_BLUEPRINT_PATH`) **se reemplazan por la capa de registro de rutas** en fase 1 (entregable propio, próximo). |
